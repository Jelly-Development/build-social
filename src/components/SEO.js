...
function SEO({ description, title, bodyClass, image = null }) {
  ...
  return (
    <Helmet bodyAttributes={{ class: bodyClass }} title={title || defaultTitle}>
      ...
      <link rel="icon" type="image/svg+xml" href="/media/img/logos/favicon.png"></link>
      <meta name="og:image" content={image || `https://buildoutsocial.com/media/img/SEO.png?test=true`} />
      <meta name="twitter:image" content={image || `https://buildoutsocial.com/media/img/SEO.png?test=true`} />
